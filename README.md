...
```bash
curl -O https://raw.githubusercontent.com/wangxiaoerYah/Reinstall/main/reinstall.sh || wget -O reinstall.sh $_
```

国内服务器：

```bash
curl -O https://gh.gorun.eu.org/https://raw.githubusercontent.com/wangxiaoerYah/Reinstall/main/reinstall.sh || wget -O reinstall.sh $_
```
